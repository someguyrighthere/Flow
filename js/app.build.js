...
function handleAdminPage() {
  ...
  function _loadLocations() {
    _loadLocations = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
      var locationListDiv, locations, locationOptionsHtml, _t7;
  ...
  if (adminContentDiv) {
    adminContentDiv.addEventListener('click', /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(e) {
        var deleteButton, id, type, confirmed, _t6;
...
function handleChecklistsPage() {
  ...
  } // Event Delegation for all actions within the checklist section
          ...
          case 3:
            ...
            if (checklists && checklists.length > 0) {
              checklists.forEach(function (checklist) {
                ...
                // *** CORRECTED CODE ***: Use checklist.checklist_id instead of checklist.id
  ...
  if (checklistSection) {
    checklistSection.addEventListener('click', /*#__PURE__*/function () {
      var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(event) {
        var viewButton, deleteButton, checklistId, checklistDetails, _checklistId, confirmed, _t11, _t12;
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.n) {
            ...
            case 2:
              checklistDetails = _context11.v;
              if (checklistDetails) {
                editChecklistIdInput.value = checklistDetails.checklist_id;
            ...
            case 3:
              _context11.p = 3;
              _t11 = _context11.v;
              showModalMessage("Failed to load checklist details: ".concat(_t11.message), true);
            case 4:
              _context11.n = 10;
              break;
            case 5:
  ...
  if (newChecklistForm) {
    newChecklistForm.addEventListener("submit", /*#__PURE__*/function () {
      var _ref9 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(e) {
        var position, title, structure_type, group_count, tasks, response, _t13;
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.n) {
            ...
            case 3:
              _context12.p = 3;
              _t13 = _context12.v;
              showModalMessage(_t13.message, true);
            case 4:
              return _context12.a(2);
          }
        }, _callee12, null, [[1, 3]]);
  ...
  if (editChecklistForm) {
    editChecklistForm.addEventListener("submit", /*#__PURE__*/function () {
      var _ref0 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13(e) {
        var checklistId, position, title, structure_type, group_count, tasks, _t14;
        return _regenerator().w(function (_context13) {
          while (1) switch (_context13.n) {
            ...
            case 3:
              _context13.p = 3;
              _t14 = _context13.v;
              showModalMessage("Error updating task list: ".concat(_t14.message), true);
            case 4:
              return _context13.a(2);
          }
        }, _callee13, null, [[1, 3]]);
