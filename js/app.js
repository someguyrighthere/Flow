...
/**
 * Main DOMContentLoaded listener to initialize page-specific logic.
 * All page handler functions are defined within this scope or above it.
 */
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOMContentLoaded: Script loaded and DOM ready.');
    const page = window.location.pathname;
    console.log('DOMContentLoaded: Current page path:', page);

    // Setup global elements like settings dropdown and logout button
    // This function definition is included right here for clarity and scope control.
    ...
    function handleAdminPage() {
        ...
        async function loadUsers() {
            ...
            if (!userListDiv) {
                console.log('handleAdminPage: User list div not found.');
                return;
            }
            userListDiv.innerHTML = '<p>Loading users...</p>';
            try {
                const users = await apiRequest('GET', '/users');
                console.log('handleAdminPage: Users loaded:', users);
        ...
        // Consolidated event listener for delete buttons
        ...
        console.log('handleAdminPage: Initial page load, loading locations and users.');
        loadLocations();
        loadUsers();
    }
    ...
    // --- Placeholder functions for other pages (DEFINED BEFORE DOMContentLoaded) ---
    ...
    // Call page-specific handlers based on the current URL
    // All handler functions are now defined above this block.
    // Call setupSettingsDropdown globally as it's present on many pages
