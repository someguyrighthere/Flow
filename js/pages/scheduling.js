...
<head>
    ...
    <style>
        ...
        .calendar-grid {
            display: grid;
            grid-template-columns: 80px 1fr; /* Time column and content area */
            min-height: 100%;
        }
        .time-column {
            position: sticky;
        ...
        .modal-content {
            background-color: rgba(26, 26, 26, 0.95); backdrop-filter: blur(15px);
            border: 1px solid rgba(255, 255, 255, 0.2); padding: 30px; border-radius: 12px;
        ...
        .daily-hours-grid .form-group {
            margin-bottom: 0;
        }
        .daily-hours-grid label {
            font-size: 0.9em;
            color: var(--text-medium);
            margin-bottom: 5px;
        }
        .daily-hours-grid input {
            padding: 8px;
            font-size: 0.9em;
            width: 100%;
            box-sizing: border-box;
            ...
            <div class="scheduling-layout">
                <div class="sidebar">
                    <div class="availability-toggle">
                        ...
                        <label for="toggle-availability">Show Availability</label>
                    </div>
                    
                    <hr style="border-color: var(--border-color); margin: 30px 0;">

                    <h3>Auto-Scheduling</h3>
                    <p style="font-size: 0.9em; color: var(--text-medium);">Set the required man-hours for each day and generate a schedule.</p>
                    
                    <div id="daily-hours-inputs" class="daily-hours-grid">
                        <!-- Inputs will be generated by JS -->
                    </div>

                    <button id="auto-generate-schedule-btn" class="btn btn-primary" style="width: 100%;">Auto-Generate</button>
                ...
                <div class="calendar-main">
                    ...
                    <div class="calendar-grid-container">
                        <!-- This is the main grid for the calendar -->
