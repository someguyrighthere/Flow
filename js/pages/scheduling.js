...
// Export the main function for app.js to import
        ...
        try {
            ...
            if (shifts && shifts.length > 0) {
                shifts.forEach(shift => {
                    ...
                    const dateTimeParts = shift.start_time.split(' '); // ["YYYY-MM-DD", "HH:MM:SS"]
                    const timeString = dateTimeParts[1];               // "HH:MM:SS"
                    ...
                    const endTimeString = endDateTimeParts[1];
                    ...
                    // To get the day index (0-6 for Sun-Sat), create a Date object from the full date string.
                    // JavaScript's Date constructor handles 'YYYY-MM-DD HH:MM:SS' strings gracefully as local time.
                    const shiftDate = new Date(shift.start_time.split(' ')[0]); // Parse just the date part for day of week
